            ...
            <div className=' container items-center text-f6' >
                ...
                </div>
                {
                    flag ? <div className=' gap-y-4 flex flex-col py-4 ' >
                        ...
                        <Link href='/advertisments'onClick={ clickHandler } >Advertisements</Link>
                        {
                            status == "authenticated" ?
                                <Link onClick={ clickHandler } href="/dashboard"className="flex items-center gap-x-2" ><IoPersonCircleOutline className=" text-lg"/>Dashboard</Link> 
                            :  <Link onClick={ clickHandler } href="/signin" className=' bg-orange px-6 py-1 rounded w-fit ' >Sign in</Link>
