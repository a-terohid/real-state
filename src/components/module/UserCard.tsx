    ...
    return (
        <div  className=" w-64 px-4 py-3 bg-f6 rounded-md shadow-md min-h-[200px]" >
            <div className="flex items-center justify-between" >
                <img className=" w-10" src={ profile.src } alt="profileImg" />
            ...
            <div className="flex flex-col mt-4 gap-y-2" >
                ...
                <div className="flex justify-end mt-3" >
                    <Link href={`/dashboard/users/${ _id }`} className="flex gap-x-1 font-bold text-orange items-center text-xs" ><BiLeftArrowAlt />See Advertisments</Link>
                </div>
            </div>
        </div>
    );
